...
public class Hero extends AbsActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemLongClickListener(new OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
				...
				// 点击william
				if (bean.text
						.equalsIgnoreCase(getString(R.string.hero_william_name))) {
					showRootCodeDialog();
				}
				// 点击善听
				else if (bean.text
						.equalsIgnoreCase(getString(R.string.hero_shanting_name))) {
					showPasswordDialog();
				}
	...
	private List<HeroBean> getdatas() {
		...
		datas.add(new HeroBean(R.drawable.hero_william,
				getString(R.string.hero_william_name),
				getString(R.string.hero_william_desc), ""));
		datas.add(new HeroBean(R.drawable.hero_shanting,
				getString(R.string.hero_shanting_name),
				getString(R.string.hero_shanting_desc), ""));

		datas.add(new HeroBean(R.drawable.hero_nongmin,
				getString(R.string.hero_nongmin_name),
				getString(R.string.hero_nongmin_desc),
				"http://weibo.com/guozisong"));

		datas.add(new HeroBean(R.drawable.hero_daxiong,
				getString(R.string.hero_daxiong_name),
				getString(R.string.hero_daxiong_desc),
				"http://weibo.com/daxionglove"));

		datas.add(new HeroBean(R.drawable.hero_guoyong,
				getString(R.string.hero_guoyong_name),
				getString(R.string.hero_guoyong_desc),
				"http://weibo.com/u/2204217141"));

		datas.add(new HeroBean(R.drawable.hero_lobo,
				getString(R.string.hero_lobo_name),
				getString(R.string.hero_lobo_desc),
				"http://weibo.com/u/1833550330"));
					...
					.setPositiveButton("确定",
							new DialogInterface.OnClickListener() {
								...
								public void onClick(DialogInterface dialog,
									...
									GuardApplication.appInstance.initConfig();
								}
							}).show();
	...
	private void showPasswordDialog() {
		final EditText edit = new EditText(mContext);
		new AlertDialog.Builder(mContext).setTitle("Pass").setView(edit)
				.setPositiveButton("确定", new DialogInterface.OnClickListener() {

					public void onClick(DialogInterface dialog, int which) {
						if (Const.rootPass.equalsIgnoreCase(String.valueOf(edit
								.getText()))) {
